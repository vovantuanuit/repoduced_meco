...
params_dict = {
    'imagenet': {
        'train_dir': os.path.expanduser('/home/tuanvovan/MeCo/zero-cost-nas/ZiCo/dataset/imagenet/train/'),
        'val_dir': os.path.expanduser('/home/tuanvovan/MeCo/zero-cost-nas/ZiCo/dataset/imagenet/val/'),
